            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-gray-400">
                        Select from our carefully crafted packages designed to meet your needs.
                    </p>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    {plans.map((plan) => (
                        <div
                            key={plan.id}
                            className={`relative pt-6 p-6 ${plan.popular ? 'backdrop-blur-lg rounded-2xl' : 'border border-gray-800 rounded-xl'
